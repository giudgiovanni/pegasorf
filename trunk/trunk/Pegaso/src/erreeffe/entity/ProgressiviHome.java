...
public class ProgressiviHome {
    ...
    public Progressivi merge(Progressivi detachedInstance) {
        ...
        try {
            Progressivi result = (Progressivi) sessionFactory.getCurrentSession()
    ...
    public Progressivi findById( erreeffe.entity.ProgressiviId id) {
        log.debug("getting Progressivi instance with id: " + id);
        try {
            Progressivi instance = (Progressivi) sessionFactory.getCurrentSession()
                    .get("erreeffe.entity.Progressivi", id);
            if (instance==null) {
    ...
    public List<Progressivi> findByExample(Progressivi instance) {
        ...
        try {
            List<Progressivi> results = (List<Progressivi>) sessionFactory.getCurrentSession()
                    .createCriteria("erreeffe.entity.Progressivi")
                    .add( create(instance) )
            .list();
