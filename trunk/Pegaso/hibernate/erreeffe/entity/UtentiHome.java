...
public class UtentiHome {
    ...
    public Utenti merge(Utenti detachedInstance) {
        ...
        try {
            Utenti result = (Utenti) sessionFactory.getCurrentSession()
    ...
    public Utenti findById( erreeffe.entity.UtentiId id) {
        log.debug("getting Utenti instance with id: " + id);
        try {
            Utenti instance = (Utenti) sessionFactory.getCurrentSession()
                    .get("erreeffe.entity.Utenti", id);
            if (instance==null) {
    ...
    public List<Utenti> findByExample(Utenti instance) {
        ...
        try {
            List<Utenti> results = (List<Utenti>) sessionFactory.getCurrentSession()
                    .createCriteria("erreeffe.entity.Utenti")
                    .add( create(instance) )
            .list();
