...
// Generated 1-lug-2009 15.41.20 by Hibernate Tools 3.2.4.GA
...
public class Ordini  implements java.io.Serializable {
     ...
     private Set<DettaglioOrdineManuale> dettaglioOrdineManuales = new HashSet<DettaglioOrdineManuale>(0);
    ...
    public Ordini(long idordine, TipoDocumento tipoDocumento, Aspetto aspetto, Pagamento pagamentoByPagamento, Causale causale, Pagamento pagamentoByIdpagamento, Clienti clienti, Date dataOrdine, Date oraOrdine, String note, String numDocumento, Date dataDocumento, Double totaleDocumento, Integer ivaDocumento, Integer docEmesso, Integer docFiscale, Integer insPn, Double speseIncasso, Double speseTrasporto, Date dataTrasp, Date oraTrasp, Integer colli, Double peso, String consegna, String porto, String diversaDest, Integer sconto, Double scontoEuro, String numeroFattura, String numeroRicevuta, String numeroNonFiscale, Long riferimentoOrdine, Set<DettaglioOrdini> dettaglioOrdinis, Set<DettaglioOrdineManuale> dettaglioOrdineManuales) {
       this.idordine = idordine;
    ...
    public void setDettaglioOrdineManuales(Set<DettaglioOrdineManuale> dettaglioOrdineManuales) {
        this.dettaglioOrdineManuales = dettaglioOrdineManuales;
    }
