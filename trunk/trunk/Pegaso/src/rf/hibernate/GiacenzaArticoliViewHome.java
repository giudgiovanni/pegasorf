 ...
 * @see rf.hibernate.GiacenzaArticoliView
...
public class GiacenzaArticoliViewHome {
	...
	public GiacenzaArticoliView findById(rf.hibernate.GiacenzaArticoliViewId id) {
		...
		try {
			GiacenzaArticoliView instance = (GiacenzaArticoliView) sessionFactory
					.getCurrentSession().get(
							"rf.hibernate.GiacenzaArticoliView", id);
			if (instance == null) {
		...
		try {
			List<GiacenzaArticoliView> results = (List<GiacenzaArticoliView>) sessionFactory
					.getCurrentSession().createCriteria(
							"rf.hibernate.GiacenzaArticoliView").add(
