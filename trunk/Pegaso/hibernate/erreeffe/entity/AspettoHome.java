 ...
 * @see erreeffe.entity.Aspetto
 * @author Hibernate Tools
 */
public class AspettoHome {
    ...
    public Aspetto findById( long id) {
        ...
        try {
            Aspetto instance = (Aspetto) sessionFactory.getCurrentSession()
                    .get("erreeffe.entity.Aspetto", id);
            if (instance==null) {
    ...
    public List<Aspetto> findByExample(Aspetto instance) {
        ...
        try {
            List<Aspetto> results = (List<Aspetto>) sessionFactory.getCurrentSession()
                    .createCriteria("erreeffe.entity.Aspetto")
                    .add( create(instance) )
            .list();
