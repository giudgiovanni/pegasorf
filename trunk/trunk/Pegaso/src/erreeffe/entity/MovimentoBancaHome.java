...
public class MovimentoBancaHome {
    ...
    public MovimentoBanca merge(MovimentoBanca detachedInstance) {
        ...
        try {
            MovimentoBanca result = (MovimentoBanca) sessionFactory.getCurrentSession()
    ...
    public MovimentoBanca findById( long id) {
        ...
        try {
            MovimentoBanca instance = (MovimentoBanca) sessionFactory.getCurrentSession()
                    .get("erreeffe.entity.MovimentoBanca", id);
            if (instance==null) {
    ...
    public List<MovimentoBanca> findByExample(MovimentoBanca instance) {
        ...
        try {
            List<MovimentoBanca> results = (List<MovimentoBanca>) sessionFactory.getCurrentSession()
                    .createCriteria("erreeffe.entity.MovimentoBanca")
                    .add( create(instance) )
            .list();
