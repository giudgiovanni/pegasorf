...
public class TmpSceltiHome {
    ...
    public List<TmpScelti> findByExample(TmpScelti instance) {
        ...
        try {
            List<TmpScelti> results = (List<TmpScelti>) sessionFactory.getCurrentSession()
                    .createCriteria("erreeffe.entity.TmpScelti")
                    .add( create(instance) )
            .list();
