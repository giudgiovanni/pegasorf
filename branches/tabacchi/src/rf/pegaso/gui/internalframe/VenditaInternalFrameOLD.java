...
public class VenditaInternalFrameOLD extends JInternalFrame{
	...
	private VenditaInternalFrameOLD frame = null;
...
//		pannelloCarrello = new JPanelRiepilogoVendita();
		...
		pannelloCarrello.setSize(new Dimension(400, 400));
...
//		pnlArticoli.caricaArticoli(art);
	...
	public void setPannelloRiepilogo(int pos){
		if ( pos == 0 ){
			JPanelRiepilogoVendita newJPanel = new JPanelRiepilogoVendita(listaPannelliRiepilogo.size()+1);
			listaPannelliRiepilogo.add(newJPanel);
			pannelloCarrello = newJPanel;
			pnlRiepilogo.add(pannelloCarrello, pannelloCarrello.getNome());
		}
		else{
			pannelloCarrello = listaPannelliRiepilogo.get(pos-1);
		}
		((CardLayout) pnlRiepilogo.getLayout()).show(pnlRiepilogo, pannelloCarrello.getNome());
...
//				double d = ControlloDati.convertPrezzoToDouble(ControlloDati.costruisciPrezzoLikePOS(importo));
	...
	class MyButtonListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			else if ( e.getSource() == btnRicercaAvanzata ){
				SceltaCassa sc = new SceltaCassa(frame, listaPannelliRiepilogo);
				sc.setVisible(true);
			}
		}
	}
...
//			jContentPane.add(pannelloCarrello, BorderLayout.WEST);
	...
	private JButton getBtnRicercaAvanzata() {
		if (btnRicercaAvanzata == null) {
			...
			btnRicercaAvanzata.addActionListener(new MyButtonListener());
		}
...
//			});
	...
	private JPanel getPnlRiepilogo() {
		if (pnlRiepilogo == null) {
			...
			pnlRiepilogo.setLayout(new CardLayout());
			pnlRiepilogo.setPreferredSize(new Dimension(600, 550));
			pnlRiepilogo.add(pannelloCarrello, pannelloCarrello.getNome());
			pnlRiepilogo.add(getBtnStorno(), "btnStorno");
			pnlRiepilogo.add(getBtnAnnullaVendita(), "btnAnnullaVendita");
			pnlRiepilogo.add(getBtnStorno1(), "btnStorno1");
		}
		return pnlRiepilogo;
	}
