...
public class ViewDocCaricoModel extends AbstractTableModel implements
	...
	private void recuperaDati() throws SQLException {
		...
		this.query = "select d.descrizione, num_documento,data_documento,a.idcarico as num_carico, c.data_carico from articoli_caricati_view as a, carico AS C,tipo_documento as d where a.idcarico=c.idcarico and c.iddocumento=d.iddocumento and a.idarticolo=? order by data_documento desc";
