 ...
 *
 */
public class BancheModel extends AbstractTableModel implements DBStateChange {
	...
	public BancheModel() throws SQLException {
	...
	private void recuperaDati() throws SQLException {
		...
		this.query = "select * from banca order by ragione_sociale";
