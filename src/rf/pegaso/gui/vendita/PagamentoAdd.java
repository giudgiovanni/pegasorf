...
public class PagamentoAdd extends JDialog {
	 ...
	 * @param owner
	 */
	public PagamentoAdd(JDialog owner) {
		super(owner, true);
		initialize();
	}
	...
	private JPanel getPnlCentrale() {
		if (pnlCentrale == null) {
			try {
				jLabel1 = new JLabel();
				jLabel1.setText("Nome Pagamento"); // Generated
	...
	private void initialize() {
		...
		this.setTitle("Inserimento Nuovo Pagamento"); // Generated
	...
	private void inserisci() {
		...
		try {
			p.insertModalitaPagamento();
		} catch (IDNonValido e) {
			JOptionPane.showMessageDialog(this,
					"Errore inserimento Nuovo Pagamento", "ERRORE",
