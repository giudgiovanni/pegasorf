...
public class CameraHome {
    ...
    public Camera merge(Camera detachedInstance) {
        ...
        try {
            Camera result = (Camera) sessionFactory.getCurrentSession()
    ...
    public Camera findById( int id) {
        ...
        try {
            Camera instance = (Camera) sessionFactory.getCurrentSession()
                    .get("erreeffe.entity.Camera", id);
            if (instance==null) {
    ...
    public List<Camera> findByExample(Camera instance) {
        log.debug("finding Camera instance by example");
        try {
            List<Camera> results = (List<Camera>) sessionFactory.getCurrentSession()
                    .createCriteria("erreeffe.entity.Camera")
                    .add( create(instance) )
            .list();
