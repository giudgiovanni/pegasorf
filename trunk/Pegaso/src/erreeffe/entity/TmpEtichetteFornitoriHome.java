...
public class TmpEtichetteFornitoriHome {
    ...
    private static final Log log = LogFactory.getLog(TmpEtichetteFornitoriHome.class);
    ...
    public TmpEtichetteFornitori merge(TmpEtichetteFornitori detachedInstance) {
        ...
        try {
            TmpEtichetteFornitori result = (TmpEtichetteFornitori) sessionFactory.getCurrentSession()
    ...
    public TmpEtichetteFornitori findById( long id) {
        ...
        try {
            TmpEtichetteFornitori instance = (TmpEtichetteFornitori) sessionFactory.getCurrentSession()
                    .get("erreeffe.entity.TmpEtichetteFornitori", id);
            if (instance==null) {
    ...
    public List<TmpEtichetteFornitori> findByExample(TmpEtichetteFornitori instance) {
        log.debug("finding TmpEtichetteFornitori instance by example");
        try {
            List<TmpEtichetteFornitori> results = (List<TmpEtichetteFornitori>) sessionFactory.getCurrentSession()
                    .createCriteria("erreeffe.entity.TmpEtichetteFornitori")
                    .add( create(instance) )
            .list();
