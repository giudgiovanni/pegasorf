...
public class UmHome {
    ...
    public Um merge(Um detachedInstance) {
        ...
        try {
            Um result = (Um) sessionFactory.getCurrentSession()
    ...
    public Um findById( long id) {
        ...
        try {
            Um instance = (Um) sessionFactory.getCurrentSession()
                    .get("erreeffe.entity.Um", id);
            if (instance==null) {
    ...
    public List<Um> findByExample(Um instance) {
        ...
        try {
            List<Um> results = (List<Um>) sessionFactory.getCurrentSession()
                    .createCriteria("erreeffe.entity.Um")
                    .add( create(instance) )
            .list();
