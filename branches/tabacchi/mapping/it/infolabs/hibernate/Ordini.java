...
public class Ordini implements java.io.Serializable {
	...
	private Set<DettaglioOrdineManuale> dettaglioOrdineManuales = new HashSet<DettaglioOrdineManuale>(
			0);
	private Set<DettaglioOrdineManuale> dettaglioOrdineManuales_1 = new HashSet<DettaglioOrdineManuale>(
			0);
	private Set<DettaglioOrdineManuale> dettaglioOrdineManuales_2 = new HashSet<DettaglioOrdineManuale>(
			0);
	...
	public Ordini(long idordine, TipoDocumento tipoDocumento, Aspetto aspetto,
			...
			Set<DettaglioOrdineManuale> dettaglioOrdineManuales_1,
			Set<DettaglioOrdineManuale> dettaglioOrdineManuales_2) {
		this.idordine = idordine;
	...
	public Set<DettaglioOrdineManuale> getDettaglioOrdineManuales_1() {
	...
	public Set<DettaglioOrdineManuale> getDettaglioOrdineManuales_2() {
