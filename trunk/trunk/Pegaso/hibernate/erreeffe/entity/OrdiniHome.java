...
public class OrdiniHome {
    ...
    public Ordini merge(Ordini detachedInstance) {
        ...
        try {
            Ordini result = (Ordini) sessionFactory.getCurrentSession()
    ...
    public Ordini findById( long id) {
        ...
        try {
            Ordini instance = (Ordini) sessionFactory.getCurrentSession()
                    .get("erreeffe.entity.Ordini", id);
            if (instance==null) {
    ...
    public List<Ordini> findByExample(Ordini instance) {
        ...
        try {
            List<Ordini> results = (List<Ordini>) sessionFactory.getCurrentSession()
                    .createCriteria("erreeffe.entity.Ordini")
                    .add( create(instance) )
            .list();
