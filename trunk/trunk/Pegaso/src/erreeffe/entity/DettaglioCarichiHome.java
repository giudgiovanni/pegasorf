...
public class DettaglioCarichiHome {
    ...
    public DettaglioCarichi merge(DettaglioCarichi detachedInstance) {
        ...
        try {
            DettaglioCarichi result = (DettaglioCarichi) sessionFactory.getCurrentSession()
    ...
    public DettaglioCarichi findById( erreeffe.entity.DettaglioCarichiId id) {
        ...
        try {
            DettaglioCarichi instance = (DettaglioCarichi) sessionFactory.getCurrentSession()
                    .get("erreeffe.entity.DettaglioCarichi", id);
            if (instance==null) {
    ...
    public List<DettaglioCarichi> findByExample(DettaglioCarichi instance) {
        ...
        try {
            List<DettaglioCarichi> results = (List<DettaglioCarichi>) sessionFactory.getCurrentSession()
                    .createCriteria("erreeffe.entity.DettaglioCarichi")
                    .add( create(instance) )
            .list();
