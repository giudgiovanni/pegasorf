...
public class Ddt implements java.io.Serializable {
	...
	public Ddt(long id, Porto porto, Causale causale, Pagamento pagamento,
			Consegna consegna, String serie, Double sconto,
			Double speseTrasporto, Double speseIncasso, String riferimento,
			Integer colli, Long destinazione) {
		this.id = id;
		this.porto = porto;
	...
	public Long getDestinazione() {
		return this.destinazione;
	}

	public void setDestinazione(Long destinazione) {
		this.destinazione = destinazione;
	}
