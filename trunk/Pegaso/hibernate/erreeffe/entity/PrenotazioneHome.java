...
public class PrenotazioneHome {
    ...
    public Prenotazione merge(Prenotazione detachedInstance) {
        ...
        try {
            Prenotazione result = (Prenotazione) sessionFactory.getCurrentSession()
    ...
    public Prenotazione findById( int id) {
        ...
        try {
            Prenotazione instance = (Prenotazione) sessionFactory.getCurrentSession()
    ...
    public List<Prenotazione> findByExample(Prenotazione instance) {
        ...
        try {
            List<Prenotazione> results = (List<Prenotazione>) sessionFactory.getCurrentSession()
                    .createCriteria("erreeffe.entity.Prenotazione")
                    .add( create(instance) )
            .list();
