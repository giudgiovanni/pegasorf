 ...
 * @see it.infolabs.hibernate.QtaScaricateView
...
public class QtaScaricateViewHome {
	...
	public QtaScaricateView findById(it.infolabs.hibernate.QtaScaricateViewId id) {
		log.debug("getting QtaScaricateView instance with id: " + id);
		try {
			QtaScaricateView instance = (QtaScaricateView) sessionFactory
					.getCurrentSession().get(
							"it.infolabs.hibernate.QtaScaricateView", id);
			if (instance == null) {
		...
		try {
			List<QtaScaricateView> results = (List<QtaScaricateView>) sessionFactory
					.getCurrentSession().createCriteria(
							"it.infolabs.hibernate.QtaScaricateView").add(
