 ...
 * @see erreeffe.entity.DettaglioOrdini
...
public class DettaglioOrdiniHome {
    ...
    public DettaglioOrdini merge(DettaglioOrdini detachedInstance) {
        ...
        try {
            DettaglioOrdini result = (DettaglioOrdini) sessionFactory.getCurrentSession()
    ...
    public DettaglioOrdini findById( erreeffe.entity.DettaglioOrdiniId id) {
        log.debug("getting DettaglioOrdini instance with id: " + id);
        try {
            DettaglioOrdini instance = (DettaglioOrdini) sessionFactory.getCurrentSession()
                    .get("erreeffe.entity.DettaglioOrdini", id);
            if (instance==null) {
    ...
    public List<DettaglioOrdini> findByExample(DettaglioOrdini instance) {
        ...
        try {
            List<DettaglioOrdini> results = (List<DettaglioOrdini>) sessionFactory.getCurrentSession()
                    .createCriteria("erreeffe.entity.DettaglioOrdini")
                    .add( create(instance) )
            .list();
