 ...
 *
 */
public class GrattaEVinciModel extends AbstractTableModel implements DBStateChange {
	...
	public GrattaEVinciModel(DBManager dbm) throws SQLException {
		this.dbm = dbm;
		recuperaDati();
	...
	private void recuperaDati() throws SQLException {
		...
		this.query = "select a.idArticolo,a.codbarre as codice,a.descrizione,a.codfornitore as aams,a.prezzo_acquisto,a.prezzo_ingrosso as prezzo_listino, f.nome as fornitore from articoli a, fornitori f where a.idfornitore=f.idfornitore and idreparto="+Constant.REPARTO_GRATTA_E_VINCI +" order by codice";
