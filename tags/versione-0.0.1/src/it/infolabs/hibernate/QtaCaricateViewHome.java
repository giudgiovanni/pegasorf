 ...
 * @see it.infolabs.hibernate.QtaCaricateView
...
public class QtaCaricateViewHome {
	...
	public QtaCaricateView findById(it.infolabs.hibernate.QtaCaricateViewId id) {
		log.debug("getting QtaCaricateView instance with id: " + id);
		try {
			QtaCaricateView instance = (QtaCaricateView) sessionFactory
					.getCurrentSession().get(
							"it.infolabs.hibernate.QtaCaricateView", id);
			if (instance == null) {
		...
		try {
			List<QtaCaricateView> results = (List<QtaCaricateView>) sessionFactory
					.getCurrentSession().createCriteria(
							"it.infolabs.hibernate.QtaCaricateView").add(
