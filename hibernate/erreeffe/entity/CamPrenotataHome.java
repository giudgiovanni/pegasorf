...
public class CamPrenotataHome {
	...
	public CamPrenotata merge(CamPrenotata detachedInstance) {
		...
		try {
			CamPrenotata result = (CamPrenotata) sessionFactory
	...
	public CamPrenotata findById(erreeffe.entity.CamPrenotataId id) {
		...
		try {
			CamPrenotata instance = (CamPrenotata) sessionFactory
					.getCurrentSession()
	...
	public List<CamPrenotata> findByExample(CamPrenotata instance) {
		...
		try {
			List<CamPrenotata> results = (List<CamPrenotata>) sessionFactory
					.getCurrentSession().createCriteria(
							"erreeffe.entity.CamPrenotata").add(
