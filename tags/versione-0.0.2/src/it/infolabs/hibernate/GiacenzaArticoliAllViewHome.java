 ...
 * @see it.infolabs.hibernate.GiacenzaArticoliAllView
...
public class GiacenzaArticoliAllViewHome {
	...
	public GiacenzaArticoliAllView findById(
			it.infolabs.hibernate.GiacenzaArticoliAllViewId id) {
		...
		try {
			GiacenzaArticoliAllView instance = (GiacenzaArticoliAllView) sessionFactory
					.getCurrentSession()
					.get("it.infolabs.hibernate.GiacenzaArticoliAllView", id);
			if (instance == null) {
		...
		try {
			List<GiacenzaArticoliAllView> results = (List<GiacenzaArticoliAllView>) sessionFactory
					.getCurrentSession().createCriteria(
							"it.infolabs.hibernate.GiacenzaArticoliAllView")
