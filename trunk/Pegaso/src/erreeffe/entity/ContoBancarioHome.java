...
public class ContoBancarioHome {
    ...
    public ContoBancario merge(ContoBancario detachedInstance) {
        ...
        try {
            ContoBancario result = (ContoBancario) sessionFactory.getCurrentSession()
    ...
    public ContoBancario findById( long id) {
        ...
        try {
            ContoBancario instance = (ContoBancario) sessionFactory.getCurrentSession()
                    .get("erreeffe.entity.ContoBancario", id);
            if (instance==null) {
    ...
    public List<ContoBancario> findByExample(ContoBancario instance) {
        ...
        try {
            List<ContoBancario> results = (List<ContoBancario>) sessionFactory.getCurrentSession()
                    .createCriteria("erreeffe.entity.ContoBancario")
                    .add( create(instance) )
            .list();
