...
public class ConvenzioneHome {
	...
	public Convenzione merge(Convenzione detachedInstance) {
		...
		try {
			Convenzione result = (Convenzione) sessionFactory
	...
	public Convenzione findById(int id) {
		...
		try {
			Convenzione instance = (Convenzione) sessionFactory
					.getCurrentSession().get("erreeffe.entity.Convenzione", id);
			if (instance == null) {
	...
	public List<Convenzione> findByExample(Convenzione instance) {
		...
		try {
			List<Convenzione> results = (List<Convenzione>) sessionFactory
					.getCurrentSession().createCriteria(
							"erreeffe.entity.Convenzione")
