 ...
 *
 */
public class TabacchiModel extends AbstractTableModel implements DBStateChange {
	...
	public TabacchiModel(DBManager dbm) throws SQLException {
		this.dbm = dbm;
		recuperaDati();
	...
	private void recuperaDati() throws SQLException {
		...
		this.query = "select a.idArticolo,a.codbarre as codice,a.descrizione,a.codfornitore as aams,a.prezzo_acquisto,a.prezzo_ingrosso as prezzo_listino, f.nome as fornitore from articoli a, fornitori f where a.idfornitore=f.idfornitore and idreparto="+Constant.REPARTO_TABACCHI +" order by codice";
