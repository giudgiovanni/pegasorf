...
public class BancaHome {
    ...
    public Banca merge(Banca detachedInstance) {
        ...
        try {
            Banca result = (Banca) sessionFactory.getCurrentSession()
    ...
    public Banca findById( long id) {
        ...
        try {
            Banca instance = (Banca) sessionFactory.getCurrentSession()
                    .get("erreeffe.entity.Banca", id);
            if (instance==null) {
    ...
    public List<Banca> findByExample(Banca instance) {
        ...
        try {
            List<Banca> results = (List<Banca>) sessionFactory.getCurrentSession()
                    .createCriteria("erreeffe.entity.Banca")
                    .add( create(instance) )
            .list();
