...
public class Fornitori implements java.io.Serializable {
	...
	public Fornitori(long idfornitore, Date dataInserimento, String nome,
			String piva, String codfisc, String via, String cap, String citta,
			String provincia, String tel, String cell, String fax,
			String email, String website, String note, String codbarre,
			Set<Carichi> carichis, Set<Articoli> articolis) {
		this.idfornitore = idfornitore;
