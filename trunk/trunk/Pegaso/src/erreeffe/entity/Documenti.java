...
public class Documenti  implements java.io.Serializable {
     ...
     private Set<DettagliDocumenti> dettagliDocumentis = new HashSet<DettagliDocumenti>(0);
    ...
    public Documenti(int id, Prenotazione prenotazione, int numDocumento, Date dataDocumento, String tipo, String stato, Double imponibileNetto, Double sconto, Double imponibileScontato, Double imposta, Double totaleDocumento, Set<DettagliDocumenti> dettagliDocumentis) {
       this.id = id;
       this.prenotazione = prenotazione;
       this.numDocumento = numDocumento;
