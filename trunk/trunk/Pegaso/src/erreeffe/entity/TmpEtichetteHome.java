...
public class TmpEtichetteHome {
    ...
    public TmpEtichette merge(TmpEtichette detachedInstance) {
        ...
        try {
            TmpEtichette result = (TmpEtichette) sessionFactory.getCurrentSession()
    ...
    public TmpEtichette findById( erreeffe.entity.TmpEtichetteId id) {
        ...
        try {
            TmpEtichette instance = (TmpEtichette) sessionFactory.getCurrentSession()
    ...
    public List<TmpEtichette> findByExample(TmpEtichette instance) {
        ...
        try {
            List<TmpEtichette> results = (List<TmpEtichette>) sessionFactory.getCurrentSession()
                    .createCriteria("erreeffe.entity.TmpEtichette")
                    .add( create(instance) )
            .list();
