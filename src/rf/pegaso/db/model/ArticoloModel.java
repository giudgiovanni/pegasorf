...
public class ArticoloModel extends AbstractTableModel implements DBStateChange {
	...
	private void recuperaDati() throws SQLException {
		...
		this.query = "select a.idArticolo,a.codbarre as codice,a.descrizione,a.prezzo_acquisto,a.prezzo_ingrosso as prezzo_listino, f.nome as fornitore from articoli a, fornitori f where a.idfornitore=f.idfornitore and (idreparto=1 or idreparto=2) order by codice";
