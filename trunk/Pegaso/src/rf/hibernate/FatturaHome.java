 ...
 * @see rf.hibernate.Fattura
 * @author Hibernate Tools
 */
public class FatturaHome {

	private static final Log log = LogFactory.getLog(FatturaHome.class);
	...
	public List<Fattura> findByExample(Fattura instance) {
		...
		try {
			List<Fattura> results = (List<Fattura>) sessionFactory
					.getCurrentSession().createCriteria("rf.hibernate.Fattura")
