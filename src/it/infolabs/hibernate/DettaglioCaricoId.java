...
/**
 * DettaglioCaricoId generated by hbm2java
 */
public class DettaglioCaricoId implements java.io.Serializable {

	private long idarticolo;
	private long idcarico;

	public DettaglioCaricoId() {
	}

	public DettaglioCaricoId(long idarticolo, long idcarico) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof DettaglioCaricoId))
			return false;
		DettaglioCaricoId castOther = (DettaglioCaricoId) other;
